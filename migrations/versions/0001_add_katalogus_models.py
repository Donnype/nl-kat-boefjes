...
Revision ID: 0001
Revises: 
Create Date: 2022-09-26 22:32:40.320467
...
def upgrade() -> None:
    ...
    op.create_table('organisation_repository',
    ...
    sa.UniqueConstraint('plugin_id', 'organisation_pk', 'repository_pk', name='unique_plugin_per_repo_per_org')
    )
